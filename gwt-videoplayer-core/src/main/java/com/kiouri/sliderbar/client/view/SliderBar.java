...
public abstract class SliderBar extends FocusPanel implements Display{
	 ...
	 */
	public void setMoreWidget(Widget moreWidget){
		if (moreWidget != null) {
	 ...
	 * @param moreWidget - widget which supports handling of onMouseClick event 
	 */	
	public void setLessWidget(Widget lessWidget){
		if (lessWidget != null) {
	 ...
	 */
	public void setDragWidget(Widget drag){
		this.drag = drag;
	}
	 ...
	 *  
	 */
	public void setScaleWidget(Widget scaleWidget, int scaleSize){

...
import net.sf.video4j.gwt.plugin.shared.vast.AdSystem;
...
import net.sf.video4j.gwt.plugin.shared.vast.Delivery;
import net.sf.video4j.gwt.plugin.shared.vast.IdURI;
import net.sf.video4j.gwt.plugin.shared.vast.Impression;
import net.sf.video4j.gwt.plugin.shared.vast.InLine;
import net.sf.video4j.gwt.plugin.shared.vast.InvalidDocumentException;
...
import net.sf.video4j.gwt.plugin.shared.vast.VideoClicks;
